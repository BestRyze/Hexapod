...
/**
 * @brief       获取ATK-MS6050 DMP处理后的数据
 * @note        获取数据的频率需与宏DEFAULT_MPU_HZ定义的频率一致，
 *              获取太快，可能因ATK-MS6050还未进行数据采样，导致FIFO中无数据，从而获取失败，
 *              获取太慢，可能无法及时读出ATK-MS6050 FIFO中的数据，导致FIFO溢出，从而获取失败
